...
internal static class Program
{
    ...
    /// of rows, saves, re-reads, and verifies those rows are 76101 while every
    ...
    private static void RunRoundtrip(string regulationPath)
    {
        ...
        try
        {
            ...
            // Enable the first 5 rows whose flag isn't already 76101.
            var toEnable = rows
            ...
            Console.WriteLine();
            Console.WriteLine($"  Rows enabled to 76101 and verified : {enabledOk}/{toEnable.Count}");
